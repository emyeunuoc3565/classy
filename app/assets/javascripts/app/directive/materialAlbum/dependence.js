! function t(e, i, n) {
    ...
    3: [function(t, e, i) {
        (function() {
            ...
            s.getListeners = function(t) {
                ...
                for (o in l) if (l.hasOwnProperty(o)) for (i = l[o].slice(0), s = i.length; s--;) n = i[s], n.once === !0 && this.removeListener(t, n.listener), r = n.listener.apply(this, e || []), r === this._getOnceReturnValue() && this.removeListener(t, n.listener);
                return this
    ...
    6: [function(t, e, i) {
        ! function(n, s) {
            ...
            if (void 0 !== a.style.transform && (o = !0), o === !1) for (var u = 0; u < l.length; u++) if (void 0 !== a.style[l[u] + "Transform"]) {
            ...
            for (var m in f) if ("undefined" != typeof a.style[m]) {
                c = f[m];
                break
            }
